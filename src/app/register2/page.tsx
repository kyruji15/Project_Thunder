  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backgroundColor: '#f0f4f8' }}>
      <div style={{ width: '100%', maxWidth: '600px', padding: '20px', backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', border: '1px solid #d1d5db' }}>
        <h2 style={{ textAlign: 'left', marginBottom: '5px', color: 'var(--new-text, #1D2939)', fontFamily: 'Inter', fontSize: '32px', fontStyle: 'normal', fontWeight: '700', lineHeight: '44px' }}>สมัครสมาชิก</h2>
        ...
        <form>
          ...
          <div style={{ marginBottom: '15px' }}>
            <label htmlFor="otp" style={{ display: 'block', marginBottom: '5px', color: 'var(--new-text, #1D2939)', fontFamily: 'Inter', fontSize: '16px', fontStyle: 'normal', fontWeight: '400', lineHeight: 'normal' }}>กรอกรหัส OTP ที่ส่งไปยังโทรศัพท์ของคุณ (Ref:02931)</label>
            <div style={{ display: 'flex', gap: '8px', justifyContent: 'left' }}>
              {[...Array(6)].map((_, index) => (
                <input
                  ...
                  type="text"
                  required
                  style={{ width: '70px', height: '50px', textAlign: 'left', border: '1px solid #ddd', borderRadius: '4px', fontSize: '16px', color: 'var(--Grey-400, #98A2B3)', fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '400', padding: '0' }}
                />
              ))}
            </div><br></br>
          </div>
