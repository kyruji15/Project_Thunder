            ...
            <div style={{ display: 'flex', gap: '10px', justifyContent: 'left' }}>
              {[...Array(6)].map((_, index) => (
                <input
                  ...
                  type="text"
                  required
                  style={{ width: '70px', height: '50px', textAlign: 'left', border: '1px solid #ddd', borderRadius: '4px', fontSize: '16px', color: 'var(--Grey-400, #98A2B3)', fontFamily: 'Inter', fontStyle: 'normal', fontWeight: '400', lineHeight: '145%' }}
                />
              ))}
            </div>
          </div>
